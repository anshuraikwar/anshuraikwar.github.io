...
export default function Hero() {
  return (
    <section className="hero-section sm:h-screen min-h-[80vh] md:min-h-[776px] md:max-h-[65vw] flex flex-col items-between justify-between">
      <div />
      <div className="flex flex-col gap-1">
        <span className="text-md">Hello!</span>
        <span className="text-5xl font-bold">I am Anshu Raikwar</span>
        <span className="text-md">Frontend Developer based in India.</span>
      </div>
      <div className="w-fit flex flex-col gap-1 relative">
        ...
        <div className="flex align-start h-[0.7em] overflow-hidden" style={{ fontSize: "min(30vw, 450px)" }}>
